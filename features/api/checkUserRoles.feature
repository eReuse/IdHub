...
Feature: Check the roles of a a given API user.
    ...
    Scenario: Check roles of a valid API user
        ...
        When "The valid API user" sends a Post request to the path "checkUserRoles" with the given parameters
    ...
    Scenario: Check roles of an invalid API user
        ...
        When "The invalid API user" sends a Post request to the path "checkUserRoles" with the given parameters
