...
Feature: Invalidate User to the API
    ...
    Scenario: Invalidate user with a valid token
        ...
        When "The valid API user" sends a Post request to the path "invalidateUser" with the given parameters
    ...
    Scenario: Invalidate user with an invalid token
        ...
        When "The invalid API user" sends a Post request to the path "invalidateUser" with the given parameters
