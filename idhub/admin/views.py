        ...
        if request.GET.get('format') == 'jwt':
            try:
                ...
                if not jwt_string:
                    ...
                    env_json_str = self.object.generate_enveloped_jwt(domain)

                    env_dict = json.loads(env_json_str)
                    jwt_string = env_dict["verifiableCredential"]["id"].split("data:application/vc+jwt,")[1]
